...
local m,F,pF,K,con,k,e,i,x,y,F1,F2,c,g,h,n,act,coc1,coc2,l,pos,ex,a,j,A1,split;
...
local m,F,pF,K,con,c,e,k,d1,i,v,w,cls,x,y,lc,gcls,F1,F2,g,act,coc1,coc2,l,pos,ex,a,j,A1,A2,h;
...
gcls := Filtered(SSortedList(Arrangements(cls),Union),x->Size(x)>0 and 2*Size(x) <= k);
SortBy(gcls,Size);
